...
class Square extends Component {
  constructor(props) {
    super(props);
    this.state = {
      colors: ['#B22222','#FFFF00','#32CD32','#00CED1','#0000CD','#FF00FF','#C71585', '#8B4513','#1383EC','#9B2FC3'],
      sizes:['40%','90%', '60%', '20%', '10%', '30%','80%','15%','100%', '200%'],
      padding:['300px','200px','100px', '75px', '400px']
  ...
  render() {
    ...
    <Rectangle className="Rectangle">
      <div style={{ background: this.state.colors[9 ] , margin:this.state.padding[0], width: this.state.sizes[0], height: this.state.sizes[0] , border: '5px solid ' + this.state.colors[8]}} />
    </Rectangle>
    </div>
    );
  }
